...
- **Calendar + Contacts** as exported components, also embedded as a right-side
  panel; plus a **Settings** panel and skeleton / empty / error / toast states.
...
| Settings | Side panel + conversation |
|------|------|
| [![Settings](docs/screenshots/settings.png)](docs/screenshots/settings.png) | [![Side panel + conversation](docs/screenshots/panel-thread.png)](docs/screenshots/panel-thread.png) |
