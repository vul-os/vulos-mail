// Package metrics is the Prometheus instrumentation for vmail (ported from
...
var (
	...
	MessagesReceived = prometheus.NewCounterVec(prometheus.CounterOpts{
		Name: "vmail_messages_received_total",
...
// Handler returns the /metrics HTTP handler exposing the vmail registry.
